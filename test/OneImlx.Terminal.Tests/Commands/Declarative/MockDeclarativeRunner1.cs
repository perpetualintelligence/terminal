...
namespace OneImlx.Terminal.Commands.Declarative
{
    ...
    [OptionDescriptor("opt3", nameof(Double), "test opt desc3", OptionFlags.Required | OptionFlags.Obsolete)]
    ...
    [ArgumentDescriptor(3, "arg3", nameof(Double), "test arg desc3", ArgumentFlags.Required | ArgumentFlags.Obsolete)]
