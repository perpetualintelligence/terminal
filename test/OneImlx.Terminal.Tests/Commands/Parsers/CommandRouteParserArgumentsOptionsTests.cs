...
namespace OneImlx.Terminal.Commands.Parsers
{
    public class CommandRouteParserArgumentsOptionsTests
    {
        ...
        public async Task Alias_With_Option_Prefix_Throws()
        {
            ...
            var options = "--opt7_a";
            Func<Task> act = async () => await commandRequestParser.ParseRequestAsync(new TerminalProcessorRequest("id1", "root1 grp1 cmd1 " + options));
        ...
        {
            var result = await commandRequestParser.ParseRequestAsync(new TerminalProcessorRequest("id1", "root1 grp1 cmd1 \"  argument    delimited  value3  \""));
        ...
        {
            Func<Task> act = async () => await commandRequestParser.ParseRequestAsync(new TerminalProcessorRequest("id1", "root1 grp1 cmd1 32 \"arg2 value true 35.987 3435345345 2312.123123 12/23/2023 12/23/2022:12:23:22"));
        ...
        public async Task Arguments_And_Options_Are_Processed_Correctly()
        {
            ...
            var result = await commandRequestParser.ParseRequestAsync(new TerminalProcessorRequest("id1", cmdStr));
        ...
        {
            var result = await commandRequestParser.ParseRequestAsync(new TerminalProcessorRequest("id1", "root1 grp1 cmd1 \"arg1 value\" 32 true 35.987 3435345345 arg6value 12/23/2023 12/23/2022:12:23:22 \"arg9 value\""));
        ...
        public async Task Arguments_With_Multiple_Separator_Not_Delimited_Exceed_Argument_Limit_Throws()
        {
            ...
            Func<Task> act = async () => await commandRequestParser.ParseRequestAsync(new TerminalProcessorRequest("id1", " root1   grp1  cmd1           \"arg1    value\"   32   true       35.987 3435345345       arg6value      12/23/2023 12/23/2022:12:23:22     arg9   value   "));
        ...
        {
            var result = await commandRequestParser.ParseRequestAsync(new TerminalProcessorRequest("id1", "root1 grp1 cmd1 \"cmd2 'cmd2_arg1' 'cmd2_arg2 value' cmd2_arg3 --opt1 val1 --opt2 val2 -opt3 --opt4 'c:\\\\somedir\\somepath\\somefile.txt'\""));
        ...
        {
            Func<Task> act = async () => await commandRequestParser.ParseRequestAsync(new TerminalProcessorRequest("id1", "root1 grp1 cmd1 " + invalidOpt));
        ...
        public async Task More_Arguments_Throws()
        {
            ...
            Func<Task> act = async () => await commandRequestParser.ParseRequestAsync(new TerminalProcessorRequest("id1", "root1 grp1 cmd1 val1 val2 val3    \"  val4   \" val5 val6 val7 val8 val9 val10 val11 "));
        ...
        public async Task More_Options_Throws()
        {
            ...
            Func<Task> act = async () => await commandRequestParser.ParseRequestAsync(new TerminalProcessorRequest("id1", cmdStr));
        ...
        {
            var result = await commandRequestParser.ParseRequestAsync(new TerminalProcessorRequest("id1", "root1 grp1 cmd1 \"\"\"arg1 delimited value\"\"\""));
        ...
        {
            var result = await commandRequestParser.ParseRequestAsync(new TerminalProcessorRequest("id1", "root1 grp1 cmd1 \"arg1 \"nested delimited value\" value\""));
        ...
        {
            var result = await commandRequestParser.ParseRequestAsync(new TerminalProcessorRequest("id1", "root1 grp1 cmd1 --opt1 \"\"\"val1\"\"\""));
        ...
        {
            var result = await commandRequestParser.ParseRequestAsync(new TerminalProcessorRequest("id1", "root1 grp1 cmd1 --opt8 false"));
        ...
        {
            var result = await commandRequestParser.ParseRequestAsync(new TerminalProcessorRequest("id1", "root1 grp1 cmd1 --opt8"));
        ...
        {
            var result = await commandRequestParser.ParseRequestAsync(new TerminalProcessorRequest("id1", "root1 grp1 cmd1 --opt3       \"  option    delimited  value3  \"      "));
        ...
        public async Task Options_Are_Processed_Correctly_In_Randomized_Order()
        {
            ...
            var result = await commandRequestParser.ParseRequestAsync(new TerminalProcessorRequest("id1", "root1 grp1 cmd1 " + options));
        ...
        {
            var result = await commandRequestParser.ParseRequestAsync(new TerminalProcessorRequest("id1", $"root1 grp1 cmd1 {arg}"));
        ...
        {
            terminalOptions.Parser.Separator = sep;
            var result = await commandRequestParser.ParseRequestAsync(new TerminalProcessorRequest("id1", $"root1{sep}grp1{sep}cmd1{sep}\"arg1{sep}value\"{sep}{sep}{sep}{sep}{sep}"));
        ...
        {
            terminalOptions.Parser.Separator = sep;
            var result = await commandRequestParser.ParseRequestAsync(new TerminalProcessorRequest("id1", $"root1{sep}grp1{sep}cmd1{sep}--opt3{sep}val3{sep}{sep}{sep}{sep}{sep}"));
        ...
        {
            Func<Task> act = async () => await commandRequestParser.ParseRequestAsync(new TerminalProcessorRequest("id1", "root1 grp1 cmd1 -opt8_a_invalid true"));
        ...
        {
            Func<Task> act = async () => await commandRequestParser.ParseRequestAsync(new TerminalProcessorRequest("id1", "root1 grp1 cmd1 --opt3_invalid \"  option    delimited  value3  \""));
