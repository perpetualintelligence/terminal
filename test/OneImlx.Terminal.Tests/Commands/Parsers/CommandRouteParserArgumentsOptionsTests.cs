...
namespace OneImlx.Terminal.Commands.Parsers
{
    public class CommandRouteParserArgumentsOptionsTests
    {
        ...
        //    var options = "--opt7_a";
        //    Func<Task> act = async () => await terminalRequestParser.ParseRequestAsync(new TerminalRequest("id1", "root1 grp1 cmd1 " + options));
        ...
        //{
        //    var result = await terminalRequestParser.ParseRequestAsync(new TerminalRequest("id1", "root1 grp1 cmd1 \"  argument    delimited  value3  \""));

        // result.Command.Id.Should().Be("cmd1"); result.Command.Options.Should().BeNull(); result.Command.Arguments.Should().NotBeNull();
        ...
        //{
        //    Func<Task> act = async () => await terminalRequestParser.ParseRequestAsync(new TerminalRequest("id1", "root1 grp1 cmd1 32 \"arg2 value true 35.987 3435345345 2312.123123 12/23/2023 12/23/2022:12:23:22"));
        ...
        //    var result = await terminalRequestParser.ParseRequestAsync(new TerminalRequest("id1", cmdStr));

        // // Command result.Command.Id.Should().Be("cmd1"); result.Command.Arguments.Should().NotBeNull(); result.Command.Options.Should().NotBeNull();

        // // Arguments result.Command.Arguments!.Count.Should().Be(9);

        // result.Command.Arguments[0].Id.Should().Be("arg1"); result.Command.Arguments[0].Value.Should().Be("arg1 value");

        // result.Command.Arguments[1].Id.Should().Be("arg2"); result.Command.Arguments[1].Value.Should().Be("32");

        // result.Command.Arguments[2].Id.Should().Be("arg3"); result.Command.Arguments[2].Value.Should().Be("true");

        // result.Command.Arguments[3].Id.Should().Be("arg4"); result.Command.Arguments[3].Value.Should().Be("35.987");

        // result.Command.Arguments[4].Id.Should().Be("arg5"); result.Command.Arguments[4].Value.Should().Be("3435345345");

        // result.Command.Arguments[5].Id.Should().Be("arg6"); result.Command.Arguments[5].Value.Should().Be("arg6value");

        // result.Command.Arguments[6].Id.Should().Be("arg7"); result.Command.Arguments[6].Value.Should().Be("12/23/2023");

        // result.Command.Arguments[7].Id.Should().Be("arg8"); result.Command.Arguments[7].Value.Should().Be("12/23/2022:12:23:22");

        // result.Command.Arguments[8].Id.Should().Be("arg9"); result.Command.Arguments[8].Value.Should().Be("arg9 value");

        // // 8 options + 4 aliases result.Command.Options!.Count.Should().Be(12);

        // Option opt1 = result.Command.Options["opt1"]; opt1.Value.Should().Be("34");

        // Option opt2 = result.Command.Options["opt2"]; opt2.Value.Should().Be("option value2");

        // Option opt3 = result.Command.Options["opt3"]; opt3.Value.Should().Be("option delimited value3");

        // Option opt4 = result.Command.Options["opt4"]; opt4.Value.Should().Be("option value4 with multiple spaces");

        // Option opt5 = result.Command.Options["opt5"]; opt5.Value.Should().Be("35.987"); Option opt5Alias =
        // result.Command.Options["opt5_a"]; opt5Alias.Value.Should().Be("35.987"); result.Command.Options["opt5"].Should().BeSameAs(result.Command.Options["opt5_a"]);

        // Option opt6 = result.Command.Options["opt6"]; opt6.Value.Should().Be("12/23/2023"); Option opt6Alias =
        // result.Command.Options["opt6_a"]; opt6Alias.Value.Should().Be("12/23/2023"); result.Command.Options["opt6"].Should().BeSameAs(result.Command.Options["opt6_a"]);

        // Option opt7 = result.Command.Options["opt7"]; opt7.Value.Should().Be(true.ToString()); // Value is not
        // provided so it is set to true (true.ToString()) Option opt7Alias = result.Command.Options["opt7_a"];
        // opt7Alias.Value.Should().Be(true.ToString()); result.Command.Options["opt7"].Should().BeSameAs(result.Command.Options["opt7_a"]);
        ...
        // string cmdStr = "root1 grp1 cmd1 \"arg1 value\" 32 true 35.987 3435345345 arg6value 12/23/2023
        // 12/23/2022:12:23:22 \"arg9 value\" -opt7_a --opt3=\"option delimited value3\" --opt4=option value4 with
        // multiple spaces --opt5=35.987 --opt1=34 -opt6_a 12/23/2023 --opt2=option value2 -opt8_a=true"; var result =
        // await terminalRequestParser.ParseRequestAsync(new TerminalRequest("id1", cmdStr));
        ...
        //{
        //    var result = await terminalRequestParser.ParseRequestAsync(new TerminalRequest("id1", "root1 grp1 cmd1 \"arg1 value\" 32 true 35.987 3435345345 arg6value 12/23/2023 12/23/2022:12:23:22 \"arg9 value\""));

        // result.Command.Id.Should().Be("cmd1");

        // result.Command.Arguments.Should().NotBeNull(); result.Command.Arguments!.Count.Should().Be(9);
        ...
        // result.Command.Id.Should().Be("cmd1"); result.Command.Options.Should().NotBeNull();

        // // Arguments result.Command.Arguments!.Count.Should().Be(9);

        // result.Command.Arguments[0].Id.Should().Be("arg1"); result.Command.Arguments[0].Value.Should().Be($"arg1{sep}value");
        ...
        // result.Command.Arguments[8].Id.Should().Be("arg9"); result.Command.Arguments[8].Value.Should().Be($"arg9{sep}value");

        // // 8 options + 4 aliases result.Command.Options!.Count.Should().Be(12);

        // Option opt1 = result.Command.Options["opt1"]; opt1.Value.Should().Be("34");

        // Option opt2 = result.Command.Options["opt2"]; opt2.Value.Should().Be($"option{sep}value2");

        // Option opt3 = result.Command.Options["opt3"]; opt3.Value.Should().Be($"option{sep}delimited{sep}value3");

        // Option opt4 = result.Command.Options["opt4"]; opt4.Value.Should().Be($"option{sep}value4{sep}{sep}{sep}{sep}with{sep}multiple{sep}{sep}spaces");
        ...
        // result.Command.Arguments[8].Id.Should().Be("arg9"); result.Command.Arguments[8].Value.Should().Be(" arg9
        // value ");
        ...
        //    Func<Task> act = async () => await terminalRequestParser.ParseRequestAsync(new TerminalRequest("id1", " root1   grp1  cmd1           \"arg1    value\"   32   true       35.987 3435345345       arg6value      12/23/2023 12/23/2022:12:23:22     arg9   value   "));
        ...
        //{
        //    var result = await terminalRequestParser.ParseRequestAsync(new TerminalRequest("id1", "root1 grp1 cmd1 \"cmd2 'cmd2_arg1' 'cmd2_arg2 value' cmd2_arg3 --opt1 val1 --opt2 val2 -opt3 --opt4 'c:\\\\somedir\\somepath\\somefile.txt'\""));

        // result.Command.Id.Should().Be("cmd1"); result.Command.Arguments.Should().NotBeNull(); result.Command.Arguments!.Count.Should().Be(1);
        ...
        // // Arguments result.Command.Arguments!.Count.Should().Be(1);
        // result.Command.Arguments[0].Id.Should().Be("arg1"); result.Command.Arguments[0].Value.Should().Be(" -- -
        // -arg1 asd&&&*ASD**ASD&A* value --");
        ...
        // string cmdStr = "root1 grp1 cmd1 --opt3=============\"option delimited value3\""; var result = await
        // terminalRequestParser.ParseRequestAsync(new TerminalRequest("id1", cmdStr));

        // // Command result.Command.Id.Should().Be("cmd1"); result.Command.Arguments.Should().BeNull(); result.Command.Options.Should().NotBeNull();
        ...
        // string cmdStr = "root1 grp1 cmd1 --opt3=\"===== =======option delimited value3=== =====\""; var result =
        // await terminalRequestParser.ParseRequestAsync(new TerminalRequest("id1", cmdStr));
        ...
        //{
        //    Func<Task> act = async () => await terminalRequestParser.ParseRequestAsync(new TerminalRequest("id1", "root1 grp1 cmd1 " + invalidOpt));
        ...
        //    Func<Task> act = async () => await terminalRequestParser.ParseRequestAsync(new TerminalRequest("id1", "root1 grp1 cmd1 val1 val2 val3    \"  val4   \" val5 val6 val7 val8 val9 val10 val11 "));
        ...
        //    Func<Task> act = async () => await terminalRequestParser.ParseRequestAsync(new TerminalRequest("id1", cmdStr));
        ...
        //{
        //    var result = await terminalRequestParser.ParseRequestAsync(new TerminalRequest("id1", "root1 grp1 cmd1 \"\"\"arg1 delimited value\"\"\""));
        ...
        //{
        //    var result = await terminalRequestParser.ParseRequestAsync(new TerminalRequest("id1", "root1 grp1 cmd1 \"arg1 \"nested delimited value\" value\""));

        // result.Command.Id.Should().Be("cmd1"); result.Command.Arguments.Should().NotBeNull(); result.Command.Arguments!.Count.Should().Be(2);

        // result.Command.Arguments[0].Id.Should().Be("arg1"); result.Command.Arguments[0].Value.Should().Be("arg1
        // \"nested delimited value");
        ...
        //{
        //    var result = await terminalRequestParser.ParseRequestAsync(new TerminalRequest("id1", "root1 grp1 cmd1 --opt1 \"\"\"val1\"\"\""));

        // result.Command.Id.Should().Be("cmd1"); result.Command.Options.Should().NotBeNull();

        // // 1 option + 1 alias result.Command.Options!.Count.Should().Be(1); result.Command.Arguments.Should().BeNull();
        ...
        //{
        //    var result = await terminalRequestParser.ParseRequestAsync(new TerminalRequest("id1", "root1 grp1 cmd1 --opt8 false"));

        // result.Command.Id.Should().Be("cmd1"); result.Command.Options.Should().NotBeNull();

        // // 1 option + 1 alias result.Command.Options!.Count.Should().Be(2); result.Command.Arguments.Should().BeNull();
        ...
        //{
        //    var result = await terminalRequestParser.ParseRequestAsync(new TerminalRequest("id1", "root1 grp1 cmd1 --opt8"));
        ...
        //{
        //    var result = await terminalRequestParser.ParseRequestAsync(new TerminalRequest("id1", "root1 grp1 cmd1 --opt3       \"  option    delimited  value3  \"      "));

        // result.Command.Id.Should().Be("cmd1"); result.Command.Options.Should().NotBeNull(); result.Command.Arguments.Should().BeNull();
        ...
        // Option opt8 = result.Command.Options["opt8"]; opt8.Value.Should().Be("false"); Option opt8Alias =
        // result.Command.Options["opt8_a"]; opt8Alias.Value.Should().Be("false"); result.Command.Options["opt8"].Should().BeSameAs(result.Command.Options["opt8_a"]);
        ...
        //    var result = await terminalRequestParser.ParseRequestAsync(new TerminalRequest("id1", "root1 grp1 cmd1 " + options));
        ...
        // // 8 options + 4 aliases result.Command.Options!.Count.Should().Be(3);

        // Option opt1 = result.Command.Options["opt2"]; opt1.Value.Should().Be("--option -value2");

        // Option opt2 = result.Command.Options["opt3"]; opt2.Value.Should().Be("option --delimited value3-");

        // Option opt3 = result.Command.Options["opt4"]; opt3.Value.Should().Be("------option -value4 with multiple spaces--------");
        ...
        //{
        //    var result = await terminalRequestParser.ParseRequestAsync(new TerminalRequest("id1", $"root1 grp1 cmd1 {arg}"));
        ...
        //{
        //    terminalOptions.Parser.Separator = sep;
        //    var result = await terminalRequestParser.ParseRequestAsync(new TerminalRequest("id1", $"root1{sep}grp1{sep}cmd1{sep}\"arg1{sep}value\"{sep}{sep}{sep}{sep}{sep}"));

        // result.Command.Id.Should().Be("cmd1"); result.Command.Options.Should().BeNull();
        ...
        //{
        //    terminalOptions.Parser.Separator = sep;
        //    var result = await terminalRequestParser.ParseRequestAsync(new TerminalRequest("id1", $"root1{sep}grp1{sep}cmd1{sep}--opt3{sep}val3{sep}{sep}{sep}{sep}{sep}"));

        // result.Command.Id.Should().Be("cmd1"); result.Command.Arguments.Should().BeNull();
        ...
        //{
        //    Func<Task> act = async () => await terminalRequestParser.ParseRequestAsync(new TerminalRequest("id1", "root1 grp1 cmd1 -opt8_a_invalid true"));
        ...
        //{
        //    Func<Task> act = async () => await terminalRequestParser.ParseRequestAsync(new TerminalRequest("id1", "root1 grp1 cmd1 --opt3_invalid \"  option    delimited  value3  \""));
