...
namespace OneImlx.Terminal.Commands.Parsers
{
    public class CommandRouteParserHindiTests
    {
        ...
        public async Task Unicode_Different_Separator_At_The_End_Are_Ignored()
        {
            ...
            var parsedCommand = await _commandRouteParser.ParseRequestAsync(new TerminalCommand("id1", $"यूनिकोड{cSep}परीक्षण{cSep}प्रिंट{cSep}{prefix}एक{oSep}  प्रथम   मान   {oSep}{prefix}दो{oSep}{alias}तीनहै{oSep}\"तीसरा मान\"{oSep}{prefix}चार{oSep}86.39{oSep}{oSep}{oSep}{cSep}{cSep}{cSep}"));
        ...
        public async Task Unicode_Different_Separator_At_The_Start_Are_Ignored()
        {
            ...
            // Here space is not treated as separator so it is included in the value.
            _terminalOptions.Parser.ParseHierarchy = true;
            var parsedCommand = await _commandRouteParser.ParseRequestAsync(new TerminalCommand("id1", $"{oSep}{oSep}{oSep}{cSep}{cSep}{cSep}यूनिकोड{cSep}परीक्षण{cSep}प्रिंट{cSep}{prefix}एक{oSep}  प्रथम   मान   {oSep}{prefix}दो{oSep}{alias}तीनहै{oSep}\"तीसरा मान\"{oSep}{prefix}चार{oSep}86.39"));
        ...
        public async Task Unicode_Hindi_Group_Extracts_Correctly()
        {
            ...
            var parsedCommand = await _commandRouteParser.ParseRequestAsync(new TerminalCommand("id1", $"यूनिकोड{separator}परीक्षण"));
        ...
        public async Task Unicode_Hindi_Group_Throws_With_Space_And_Custom_Separator()
        {
            ...
            Func<Task> act = async () => await _commandRouteParser.ParseRequestAsync(new TerminalCommand("id1", "यूनिकोडएसपरीक्षण  "));
        ...
        public async Task Unicode_Hindi_Group_With_Multiple_Separator_And_Spaces_Should_Error()
        {
            ...
            Func<Task> act = async () => await _commandRouteParser.ParseRequestAsync(new TerminalCommand("id1", $"{separator}यूनिकोड{separator}{separator}{separator}  परीक्षण{separator}{separator}{separator}{separator}"));
            await act.Should().ThrowAsync<TerminalException>().WithMessage("The command does not support any arguments. command=यूनिकोड");
        }
        ...
        public async Task Unicode_Hindi_Group_With_Multiple_Separator_Extracts_Correctly()
        {
            ...
            var parsedCommand = await _commandRouteParser.ParseRequestAsync(new TerminalCommand("id1", $"{separator}यूनिकोड{separator}{separator}{separator}परीक्षण{separator}{separator}{separator}{separator}"));
        ...
        {
            var parsedCommand = await _commandRouteParser.ParseRequestAsync(new TerminalCommand("id1", "यूनिकोड"));
        ...
        public async Task Unicode_Hindi_SubCommand_Extracts_Correctly()
        {
            ...
            var parsedCommand = await _commandRouteParser.ParseRequestAsync(new TerminalCommand("प्रिंट", $"यूनिकोड{separator}परीक्षण{separator}प्रिंट"));
        ...
        public async Task Unicode_Hindi_SubCommand_Options_Extracts_Correctly()
        {
            ...
            _terminalOptions.Parser.ParseHierarchy = true;
            var parsedCommand = await _commandRouteParser.ParseRequestAsync(new TerminalCommand("id1", $"यूनिकोड{sep}परीक्षण{sep}प्रिंट{sep}{prefix}एक{sep}{sep}{sep}प्रथम मान{sep}{sep}{sep}{prefix}दो{sep}{alias}तीनहै{sep}\"तीसरा मान\"{sep}{prefix}चार{sep}86.39"));
        ...
        public async Task Unicode_Hindi_SubCommand_Second_Extracts_Correctly()
        {
            ...
            var parsedCommand = await _commandRouteParser.ParseRequestAsync(new TerminalCommand("id1", $"यूनिकोड{separator}परीक्षण{separator}दूसरा"));
        ...
        public async Task Unicode_Hindi_SubCommand_With_Different_Separator_With_Space_Options_Extracts_Correctly()
        {
            ...
            // Here space is not treated as separator so it is included in the value.
            _terminalOptions.Parser.ParseHierarchy = true;
            var parsedCommand = await _commandRouteParser.ParseRequestAsync(new TerminalCommand("id1", $"यूनिकोड{cSep}परीक्षण{cSep}प्रिंट{cSep}{prefix}एक{oSep}  प्रथम   मान   {oSep}{prefix}दो{oSep}{alias}तीनहै{oSep}\"तीसरा मान\"{oSep}{prefix}चार{oSep}86.39"));
        ...
        public async Task Unicode_Hindi_SubCommand_With_Space_Options_Extracts_Correctly()
        {
            ...
            // Here space is not treated as separator so it is included in the value.
            _terminalOptions.Parser.ParseHierarchy = true;
            var parsedCommand = await _commandRouteParser.ParseRequestAsync(new TerminalCommand("id1", $"यूनिकोड{sep}परीक्षण{sep}प्रिंट{sep}{prefix}एक{sep}  प्रथम   मान   {sep}{prefix}दो{sep}{alias}तीनहै{sep}\"तीसरा मान\"{sep}{prefix}चार{sep}86.39"));
