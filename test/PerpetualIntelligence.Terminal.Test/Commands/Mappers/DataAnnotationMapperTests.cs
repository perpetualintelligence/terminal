...
#pragma warning restore CS8625 // Cannot convert null literal to non-nullable reference type.
        ...
        public async Task UnsupportedCustomDataTypeShouldErrorAsync()
        {
            ...
            await TestHelper.AssertThrowsErrorExceptionAsync(() => mapper.MapAsync(new OptionDataTypeMapperContext(option)), TerminalErrors.UnsupportedOption, "The option custom data type is not supported. option=arg1 custom_data_type=unsupported_custom");
        }
