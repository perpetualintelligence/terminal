...
namespace PerpetualIntelligence.Terminal.Commands.Extractors
{
    ...
    public class OptionsCommandExtractorTests : LoggerTests<OptionsCommandExtractorTests>
    {
        ...
        public async Task AdditionalSeparatorsShouldBeIgnored()
        {
            ...
            AssertCommand(result.ExtractedCommand.Command, "orgid", "pi", 5);

            Assert.IsNotNull(result.ExtractedCommand.Command.Options);
            AssertOption(result.ExtractedCommand.Command.Options[0], "key1", DataType.Text, "Key1 value text", "value1", "key1_alias");
            AssertOption(result.ExtractedCommand.Command.Options[1], "key2-er", DataType.Text, "Key2 value text", "value2", null);
            AssertOption(result.ExtractedCommand.Command.Options[2], "key6-a-s-xx-s", nameof(Boolean), "Key6 no value", true.ToString(), null);
            AssertOption(result.ExtractedCommand.Command.Options[3], "key9", nameof(Double), "Key9 invalid default value", "25.36", null);
            AssertOption(result.ExtractedCommand.Command.Options[4], "key12", nameof(Boolean), "Key12 value default boolean", true.ToString(), "k12");
        }
        ...
        public async Task AliasIdShouldExtractCorrectly()
        {
            ...
            AssertCommand(result.ExtractedCommand.Command, "orgid", "pi", 1);
            Assert.IsNotNull(result.ExtractedCommand.Command.Options);
            AssertOption(result.ExtractedCommand.Command.Options[0], "key1", DataType.Text, "Key1 value text", "value1", "key1_alias");
            Assert.AreEqual("key1_alias", result.ExtractedCommand.Command.Options[0].Alias);
        }
        ...
        public async Task MixedOptionsAndAliasShouldExtractCorrectly()
        {
            ...
            AssertCommand(result.ExtractedCommand.Command, "orgid", "pi", 8);

            Assert.IsNotNull(result.ExtractedCommand.Command.Options);
            AssertOption(result.ExtractedCommand.Command.Options[0], "key1", DataType.Text, "Key1 value text", "value1", "key1_alias");
            AssertOption(result.ExtractedCommand.Command.Options[1], "key2-er", DataType.Text, "Key2 value text", "value2", null);
            AssertOption(result.ExtractedCommand.Command.Options[2], "key3-a-z-d", DataType.PhoneNumber, "Key3 value phone", "(551) 208 9779", "k3");
            AssertOption(result.ExtractedCommand.Command.Options[3], "key6-a-s-xx-s", nameof(Boolean), "Key6 no value", true.ToString(), null);
            AssertOption(result.ExtractedCommand.Command.Options[4], "key9", nameof(Double), "Key9 invalid default value", "25.36", null);
            AssertOption(result.ExtractedCommand.Command.Options[5], "key10", nameof(String), "Key10 value custom string", "value10", "k10");
            AssertOption(result.ExtractedCommand.Command.Options[6], "key11", nameof(Boolean), "Key11 value boolean", true.ToString(), "k11");
            AssertOption(result.ExtractedCommand.Command.Options[7], "key12", nameof(Boolean), "Key12 value default boolean", true.ToString(), "k12");
        }
        ...
        public async Task MixedOptionsInRandomOrderAndAliasShouldExtractCorrectly()
        {
            ...
            Assert.IsNotNull(result.ExtractedCommand.Command.Options);
            AssertOption(result.ExtractedCommand.Command.Options[0], "key11", nameof(Boolean), "Key11 value boolean", true.ToString(), "k11");
            AssertOption(result.ExtractedCommand.Command.Options[1], "key3-a-z-d", DataType.PhoneNumber, "Key3 value phone", "(551) 208 9779", "k3");
            AssertOption(result.ExtractedCommand.Command.Options[2], "key9", nameof(Double), "Key9 invalid default value", "25.36", null);
            AssertOption(result.ExtractedCommand.Command.Options[3], "key2-er", DataType.Text, "Key2 value text", "value2", null);
            AssertOption(result.ExtractedCommand.Command.Options[4], "key12", nameof(Boolean), "Key12 value default boolean", true.ToString(), "k12");
            AssertOption(result.ExtractedCommand.Command.Options[5], "key6-a-s-xx-s", nameof(Boolean), "Key6 no value", true.ToString(), null);
            AssertOption(result.ExtractedCommand.Command.Options[6], "key1", DataType.Text, "Key1 value text", "value1", "key1_alias");
            AssertOption(result.ExtractedCommand.Command.Options[7], "key10", nameof(String), "Key10 value custom string", "value10", "k10");
        }
        ...
        public async Task MixedOptionsInReverseAndAliasShouldExtractCorrectly()
        {
            ...
            Assert.IsNotNull(result.ExtractedCommand.Command.Options);
            AssertOption(result.ExtractedCommand.Command.Options[7], "key1", DataType.Text, "Key1 value text", "value1", "key1_alias");
            AssertOption(result.ExtractedCommand.Command.Options[6], "key2-er", DataType.Text, "Key2 value text", "value2", null);
            AssertOption(result.ExtractedCommand.Command.Options[5], "key3-a-z-d", DataType.PhoneNumber, "Key3 value phone", "(551) 208 9779", "k3");
            AssertOption(result.ExtractedCommand.Command.Options[4], "key6-a-s-xx-s", nameof(Boolean), "Key6 no value", true.ToString(), null);
            AssertOption(result.ExtractedCommand.Command.Options[3], "key9", nameof(Double), "Key9 invalid default value", "25.36", null);
            AssertOption(result.ExtractedCommand.Command.Options[2], "key10", nameof(String), "Key10 value custom string", "value10", "k10");
            AssertOption(result.ExtractedCommand.Command.Options[1], "key11", nameof(Boolean), "Key11 value boolean", true.ToString(), "k11");
            AssertOption(result.ExtractedCommand.Command.Options[0], "key12", nameof(Boolean), "Key12 value default boolean", true.ToString(), "k12");
        }
        ...
        public async Task NoOptionsShouldExtractCorrectly()
        {
            ...
            AssertCommand(result.ExtractedCommand.Command, "orgid", "pi", null);
        }
        ...
        protected override void OnTestInitialize()
        {
            ...
            commandStore = new InMemoryCommandStore(textHandler, MockCommands.GroupedOptionsCommands, options, TestLogger.Create<InMemoryCommandStore>());
            optionExtractor = new OptionExtractor(textHandler, options, TestLogger.Create<OptionExtractor>());
