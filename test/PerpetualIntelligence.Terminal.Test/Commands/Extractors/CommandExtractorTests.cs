...
namespace PerpetualIntelligence.Terminal.Commands.Extractors
{
    ...
    public class CommandExtractorTests : InitializerTests
    {
        ...
        public async Task AliasConfiguredDifferentPrefixValueDelimiterValidAliasShouldError(string prefix, string cmdId, string cmdName)
        {
            ...
            // Reset commands
            commandStore = new InMemoryCommandStore(textHandler, MockCommands.AliasCommands, terminalOptions, TestLogger.Create<InMemoryCommandStore>());
            extractor = new CommandExtractor(routeParser, commandStore, optionExtractor, textHandler, terminalOptions, TestLogger.Create<CommandExtractor>());
        ...
        public async Task AliasConfiguredValidCommandStringWithAliasShouldNotError(string prefix, string cmdId)
        {
            ...
            Assert.AreEqual(prefix, result.ExtractedCommand.Command.Descriptor.Prefix);
            Assert.AreEqual(cmdId, result.ExtractedCommand.Command.Id);

            Assert.IsNotNull(result.ExtractedCommand.Command.Options);
            AssertOption(result.ExtractedCommand.Command.Options[0], "key1", DataType.Text, "Key1 value text", "value1");
            AssertOption(result.ExtractedCommand.Command.Options[1], "key2", DataType.Text, "Key2 value text", "value2");
            AssertOption(result.ExtractedCommand.Command.Options[2], "key3", DataType.PhoneNumber, "Key3 value phone", "value3");
            AssertOption(result.ExtractedCommand.Command.Options[3], "key4", nameof(Double), "Key4 value number", "25.36");
        }
        ...
        public async Task BadCustomArgExtractorShouldErrorAsync()
        {
            ...
            var badExtractor = new CommandExtractor(routeParser, commandStore, new MockBadOptionExtractor(), textHandler, terminalOptions, TestLogger.Create<CommandExtractor>());
        ...
        public async Task CommandSeparatorAndOptionSeparatorCanBeSameAsync(string separator)
        {
            ...
            AssertOption(result.ExtractedCommand.Command.Options[0], "key1", DataType.Text, "Key1 value text", "value1");
            AssertOption(result.ExtractedCommand.Command.Options[1], "key2", DataType.Text, "Key2 value text", "value2");
            AssertOption(result.ExtractedCommand.Command.Options[2], "key6", nameof(Boolean), "Key6 no value", "True");
            AssertOption(result.ExtractedCommand.Command.Options[3], "key9", nameof(Double), "Key9 value custom double", "26.36");
        }
        ...
        public async Task CommandStringShouldAllowOptionPrefixInOptionValueAsync(string prefix)
        {
            ...
            Assert.IsNotNull(result.ExtractedCommand.Command.Options);
            Assert.AreEqual(4, result.ExtractedCommand.Command.Options.Count);
            AssertOption(result.ExtractedCommand.Command.Options[0], "key1", DataType.Text, "Key1 value text", $"Test{prefix}prefix{prefix}message");
            AssertOption(result.ExtractedCommand.Command.Options[1], "key2", DataType.Text, "Key2 value text", "nospacemessage");
            AssertOption(result.ExtractedCommand.Command.Options[2], "key6", nameof(Boolean), "Key6 no value", "True");
            AssertOption(result.ExtractedCommand.Command.Options[3], "key10", nameof(String), "Key10 value custom string", $"Again{prefix}with{prefix}prefix");
        }
        ...
        public async Task CommandStringShouldAllowOptionSeparatorInOptionValueAsync(string separator)
        {
            ...
            Assert.IsNotNull(result.ExtractedCommand.Command.Options);
            Assert.AreEqual(4, result.ExtractedCommand.Command.Options.Count);
            AssertOption(result.ExtractedCommand.Command.Options[0], "key1", DataType.Text, "Key1 value text", $"Test{separator}separator{separator}message");
            AssertOption(result.ExtractedCommand.Command.Options[1], "key2", DataType.Text, "Key2 value text", "nosseparatormessage");
            AssertOption(result.ExtractedCommand.Command.Options[2], "key6", nameof(Boolean), "Key6 no value", "True");
            AssertOption(result.ExtractedCommand.Command.Options[3], "key10", nameof(String), "Key10 value custom string", $"Again{separator}with{separator}separator");
        }
        ...
        public async Task CommandStringShouldAllowCommandSeparatorInOptionValueAsync(string separator)
        {
            ...
            Assert.IsNotNull(result.ExtractedCommand.Command.Options);
            Assert.AreEqual(4, result.ExtractedCommand.Command.Options.Count);
            AssertOption(result.ExtractedCommand.Command.Options[0], "key1", DataType.Text, "Key1 value text", $"Test{separator}space{separator}message");
            AssertOption(result.ExtractedCommand.Command.Options[1], "key2", DataType.Text, "Key2 value text", "nospacemessage");
            AssertOption(result.ExtractedCommand.Command.Options[2], "key6", nameof(Boolean), "Key6 no value", "True");
            AssertOption(result.ExtractedCommand.Command.Options[3], "key10", nameof(String), "Key10 value custom string", $"Again{separator}with{separator}space");
        }
        ...
        public async Task CommandStringShouldAllowMultipleSeparatorForArgumentAndOptionValueAsync(string separator)
        {
            ...
            Assert.IsNotNull(result.ExtractedCommand.Command.Options);
            Assert.AreEqual(4, result.ExtractedCommand.Command.Options.Count);
            AssertOption(result.ExtractedCommand.Command.Options[0], "key1", DataType.Text, "Key1 value text", $"Test{separator}{separator}space{separator}{separator}{separator}{separator}message");
            AssertOption(result.ExtractedCommand.Command.Options[1], "key2", DataType.Text, "Key2 value text", "nospacemessage");
            AssertOption(result.ExtractedCommand.Command.Options[2], "key6", nameof(Boolean), "Key6 no value", "True");
            AssertOption(result.ExtractedCommand.Command.Options[3], "key10", nameof(String), "Key10 value custom string", $"Again{separator}with{separator}{separator}space");
        }
        ...
        public async Task CommandStringShouldStripSeparatorAtTheEndOfOptionValueAsync(string separator)
        {
            ...
            Assert.IsNotNull(result.ExtractedCommand);
            Assert.IsNotNull(result.ExtractedCommand.Command.Options);
            Assert.AreEqual(1, result.ExtractedCommand.Command.Options.Count);
            AssertOption(result.ExtractedCommand.Command.Options[0], "key1", DataType.Text, "Key1 value text", $"Test space message");
        }
        ...
        public async Task DefaultOptionShouldWorkCorrectlyWithoutItsValueAsync()
        {
            ...
            Assert.IsNotNull(result.ExtractedCommand.Command.Options);
            Assert.AreEqual(2, result.ExtractedCommand.Command.Options.Count);
            AssertOption(result.ExtractedCommand.Command.Options[0], "key2", DataType.Text, "Key2 value text", "hello");
            AssertOption(result.ExtractedCommand.Command.Options[1], "key6", nameof(Boolean), "Key6 no value", "True");
        }
        ...
        {
            CommandExtractorContext context = new(new CommandRoute("id1", "prefix5_default"));
            CommandExtractor noProviderExtractor = new(routeParser, commandStore, optionExtractor, textHandler, terminalOptions, TestLogger.Create<CommandExtractor>());
        ...
        {
            // Reset commands
            commandStore = new InMemoryCommandStore(textHandler, MockCommands.GroupedCommands, terminalOptions, TestLogger.Create<InMemoryCommandStore>());
            extractor = new CommandExtractor(routeParser, commandStore, optionExtractor, textHandler, terminalOptions, TestLogger.Create<CommandExtractor>());
...
#pragma warning restore CA1806 // Do not ignore method results
        ...
        public async Task PrefixMatchButDifferentCommandNameShouldNotError()
        {
            ...
            Assert.AreEqual("id1", result.ExtractedCommand.Command.Descriptor.Id);
            Assert.AreEqual("name1", result.ExtractedCommand.Command.Descriptor.Name);
            Assert.AreEqual("prefix1", result.ExtractedCommand.Command.Descriptor.Prefix);
        }
        ...
        public async Task PrefixMatchSameCommandNameShouldNotError()
        {
            ...
            var result = await extractor.ExtractAsync(context);
            Assert.IsNotNull(result.ExtractedCommand.Command.Descriptor);
            Assert.AreEqual("id2", result.ExtractedCommand.Command.Descriptor.Id);
            Assert.AreEqual("name2", result.ExtractedCommand.Command.Descriptor.Name);
            Assert.AreEqual("name2", result.ExtractedCommand.Command.Descriptor.Prefix);
        }
        ...
        public async Task PrefixMatchWithMultipleWordsShouldNotError()
        {
            ...
            var result = await extractor.ExtractAsync(context);
            Assert.IsNotNull(result.ExtractedCommand.Command.Descriptor);
            Assert.AreEqual("id3", result.ExtractedCommand.Command.Descriptor.Id);
            Assert.AreEqual("name3", result.ExtractedCommand.Command.Descriptor.Name);
            Assert.AreEqual("prefix3 sub3 name3", result.ExtractedCommand.Command.Descriptor.Prefix);
        }
        ...
        public async Task ValidCommandStringShouldNotErrorAndPopulateCorrectly(string separator)
        {
            ...
            Assert.AreEqual("name2", result.ExtractedCommand.Command.Descriptor.Name);
            Assert.AreEqual("name2", result.ExtractedCommand.Command.Descriptor.Prefix);
            Assert.AreEqual("desc2", result.ExtractedCommand.Command.Descriptor.Description);
            Assert.AreEqual(typeof(CommandChecker), result.ExtractedCommand.Command.Descriptor.Checker);
            Assert.AreEqual(typeof(CommandRunner<CommandRunnerResult>), result.ExtractedCommand.Command.Descriptor.Runner);
            Assert.IsNotNull(result.ExtractedCommand.Command.Descriptor.OptionDescriptors);
            Assert.AreEqual(10, result.ExtractedCommand.Command.Descriptor.OptionDescriptors.Count);
            AssertOptionDescriptor(result.ExtractedCommand.Command.Descriptor.OptionDescriptors[0], "key1", DataType.Text, "Key1 value text");
            AssertOptionDescriptor(result.ExtractedCommand.Command.Descriptor.OptionDescriptors[1], "key2", DataType.Text, "Key2 value text");
            AssertOptionDescriptor(result.ExtractedCommand.Command.Descriptor.OptionDescriptors[2], "key3", DataType.PhoneNumber, "Key3 value phone");
            AssertOptionDescriptor(result.ExtractedCommand.Command.Descriptor.OptionDescriptors[3], "key4", DataType.EmailAddress, "Key4 value email");
            AssertOptionDescriptor(result.ExtractedCommand.Command.Descriptor.OptionDescriptors[4], "key5", DataType.Url, "Key5 value url");
            AssertOptionIdentity(result.ExtractedCommand.Command.Descriptor.OptionDescriptors[5], "key6", nameof(Boolean), "Key6 no value");
            AssertOptionDescriptor(result.ExtractedCommand.Command.Descriptor.OptionDescriptors[6], "key7", DataType.Currency, "Key7 value currency", new DataValidationOptionValueChecker[] { new(new OneOfAttribute("INR", "USD", "EUR")) });
            AssertOptionIdentity(result.ExtractedCommand.Command.Descriptor.OptionDescriptors[7], "key8", nameof(Int32), "Key8 value custom int");
            AssertOptionIdentity(result.ExtractedCommand.Command.Descriptor.OptionDescriptors[8], "key9", nameof(Double), "Key9 value custom double", new DataValidationOptionValueChecker[] { new(new RequiredAttribute()), new(new OneOfAttribute(2.36, 25.36, 3669566.36, 26.36, -36985.25, 0, -5)) });
            AssertOptionIdentity(result.ExtractedCommand.Command.Descriptor.OptionDescriptors[9], "key10", nameof(String), "Key10 value custom string");

            // Supported options 10, user only passed 7
            Assert.IsNotNull(result.ExtractedCommand);
            Assert.AreEqual("id2", result.ExtractedCommand.Command.Id);
            Assert.AreEqual("name2", result.ExtractedCommand.Command.Name);
            Assert.AreEqual("desc2", result.ExtractedCommand.Command.Description);
            Assert.IsNotNull(result.ExtractedCommand.Command.Options);
            Assert.AreEqual(7, result.ExtractedCommand.Command.Options.Count);
            AssertOption(result.ExtractedCommand.Command.Options[0], "key1", DataType.Text, "Key1 value text", "value1");
            AssertOption(result.ExtractedCommand.Command.Options[1], "key2", DataType.Text, "Key2 value text", "value2");
            AssertOption(result.ExtractedCommand.Command.Options[2], "key3", DataType.PhoneNumber, "Key3 value phone", "+1-2365985632");
            AssertOption(result.ExtractedCommand.Command.Options[3], "key4", DataType.EmailAddress, "Key4 value email", "testmail@gmail.com");
            AssertOption(result.ExtractedCommand.Command.Options[4], "key5", DataType.Url, "Key5 value url", "C:\\apps\\devop_tools\\bin\\wntx64\\i18nnotes.txt");
            AssertOption(result.ExtractedCommand.Command.Options[5], "key6", "Boolean", "Key6 no value", "True");
            AssertOption(result.ExtractedCommand.Command.Options[6], "key9", "Double", "Key9 value custom double", "33.368");
        }
        ...
        public async Task ValidCommandStringWithinCommandGroupShouldNotErrorAsync()
        {
            ...
            var result = await extractor.ExtractAsync(context);
            Assert.IsNotNull(result.ExtractedCommand.Command.Descriptor);
            Assert.AreEqual("orgid", result.ExtractedCommand.Command.Descriptor.Id);
            Assert.AreEqual("pi", result.ExtractedCommand.Command.Descriptor.Name);

            context = new CommandExtractorContext(new CommandRoute("id1", "pi auth"));
            result = await extractor.ExtractAsync(context);
            Assert.IsNotNull(result.ExtractedCommand.Command.Descriptor);
            Assert.AreEqual("orgid:authid", result.ExtractedCommand.Command.Descriptor.Id);
            Assert.AreEqual("auth", result.ExtractedCommand.Command.Descriptor.Name);

            context = new CommandExtractorContext(new CommandRoute("id1", "pi auth login"));
            result = await extractor.ExtractAsync(context);
            Assert.IsNotNull(result.ExtractedCommand.Command.Descriptor);
            Assert.AreEqual("orgid:authid:loginid", result.ExtractedCommand.Command.Descriptor.Id);
            Assert.AreEqual("login", result.ExtractedCommand.Command.Descriptor.Name);

            context = new CommandExtractorContext(new CommandRoute("id1", "pi auth slogin"));
            result = await extractor.ExtractAsync(context);
            Assert.IsNotNull(result.ExtractedCommand.Command.Descriptor);
            Assert.AreEqual("orgid:authid:sloginid", result.ExtractedCommand.Command.Descriptor.Id);
            Assert.AreEqual("slogin", result.ExtractedCommand.Command.Descriptor.Name);

            context = new CommandExtractorContext(new CommandRoute("id1", "pi auth slogin oidc"));
            result = await extractor.ExtractAsync(context);
            Assert.IsNotNull(result.ExtractedCommand.Command.Descriptor);
            Assert.AreEqual("orgid:authid:sloginid:oidc", result.ExtractedCommand.Command.Descriptor.Id);
            Assert.AreEqual("oidc", result.ExtractedCommand.Command.Descriptor.Name);

            context = new CommandExtractorContext(new CommandRoute("id1", "pi auth slogin oauth"));
            result = await extractor.ExtractAsync(context);
            Assert.IsNotNull(result.ExtractedCommand.Command.Descriptor);
            Assert.AreEqual("orgid:authid:sloginid:oauth", result.ExtractedCommand.Command.Descriptor.Id);
            Assert.AreEqual("oauth", result.ExtractedCommand.Command.Descriptor.Name);
        }
        ...
        public async Task Options_Are_Extracted_Correctly_With_Multiple_ValueValueDelimiter_WithQuotes_Async()
        {
            ...
            var result = await extractor.ExtractAsync(context);
            Assert.IsNotNull(result.ExtractedCommand.Command.Options);
            AssertOption(result.ExtractedCommand.Command.Options[0], "key1", DataType.Text, "Key1 value text", "key1_value");
            AssertOption(result.ExtractedCommand.Command.Options[1], "key2", DataType.Text, "Key2 value text", "date -s '20 JUN 2023 11:06:38'");
        }
        ...
        public async Task Options_Are_Extracted_Correctly_With_Multiple_Alias_ValueValueDelimiter_WithQuotes_Async()
        {
            ...
            var result = await extractor.ExtractAsync(context);
            Assert.IsNotNull(result.ExtractedCommand.Command.Options);
            AssertOption(result.ExtractedCommand.Command.Options[0], "key1", DataType.Text, "Key1 value text", "date -s '15 JUN 2023 11:06:38'");
            AssertOption(result.ExtractedCommand.Command.Options[1], "key2", DataType.Text, "Key2 value text", "date -s '20 JUN 2023 11:06:38'");
        }
        ...
        public async Task Options_Are_Extracted_Correctly_With_Single_Value_Has_Another_Option_ValueValueDelimiterAsync()
        {
            ...
            var result = await extractor.ExtractAsync(context);
            Assert.IsNotNull(result.ExtractedCommand.Command.Options);
            AssertOption(result.ExtractedCommand.Command.Options[0], "key1", DataType.Text, "Key1 value text", "cmd --opt1 val1 --opt2 val2 --opt3");
        }
        ...
        public async Task Options_Are_Extracted_Correctly_With_Multiple_ValueValueDelimiterAsync()
        {
            ...
            Assert.IsNotNull(result.ExtractedCommand.Command.Options);
            AssertOption(result.ExtractedCommand.Command.Options[0], "key1", DataType.Text, "Key1 value text", "key1_value");
            AssertOption(result.ExtractedCommand.Command.Options[1], "key2", DataType.Text, "Key2 value text", "key2_value");
        }
        ...
        public async Task Options_Are_Extracted_Correctly_With_Multiple_Alias_ValueValueDelimiterAsync()
        {
            ...
            Assert.IsNotNull(result.ExtractedCommand.Command.Options);
            AssertOption(result.ExtractedCommand.Command.Options[0], "key1", DataType.Text, "Key1 value text", "key1_value");
            AssertOption(result.ExtractedCommand.Command.Options[1], "key5", DataType.Text, "Key5 value text", "key5_value");
        }
        ...
        private void SetupBasedOnTerminalOptions(TerminalOptions terminalOptionsIpt)
        {
            ...
            commandStore = new InMemoryCommandStore(textHandler, MockCommands.Commands, terminalOptionsIpt, TestLogger.Create<InMemoryCommandStore>());
            optionExtractor = new OptionExtractor(textHandler, terminalOptionsIpt, TestLogger.Create<OptionExtractor>());
            extractor = new CommandExtractor(routeParser, commandStore, optionExtractor, textHandler, terminalOptionsIpt, TestLogger.Create<CommandExtractor>());
        }
