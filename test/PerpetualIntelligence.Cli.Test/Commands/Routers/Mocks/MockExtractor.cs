...
#pragma warning disable CS8625 // Cannot convert null literal to non-nullable reference type.
                    return Task.FromResult(new CommandExtractorResult(null, new CommandIdentity("test_id", "test_name", "test_prefix", null)));
...
#pragma warning restore CS8625 // Cannot convert null literal to non-nullable reference type.
                ...
                {
                    // all ok
                    return Task.FromResult(new CommandExtractorResult(new Command() { Id = "test_id", Name = "test_name" }, new CommandIdentity("test_id", "test_name", "test_prefix", null)));
                }
            }
        }
    }
