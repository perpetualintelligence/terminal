...
namespace PerpetualIntelligence.Cli.Runtime
{
    ...
    /// </summary>
    /// <remarks>
    /// Most terminals show helpful messages to the user as it runs a command. The <see cref="ITerminalLogger{TCategoryName}"/> abstraction allows
    ...
    /// </remarks>
    public interface ITerminalLogger<out TCategoryName> : ILogger<TCategoryName>
    {
    }
}