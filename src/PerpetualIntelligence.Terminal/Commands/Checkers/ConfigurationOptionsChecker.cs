    ...
    public class ConfigurationOptionsChecker : IConfigurationOptionsChecker
    {
        ...
        public Task CheckAsync(TerminalOptions options)
        {
            ...
            // Terminal
            {
                ...
                {
                    throw new ErrorException(TerminalErrors.InvalidConfiguration, "The terminal identifier is required.");
                }
            }
            ...
            // Driver
            {
                if (options.Driver.Enabled.GetValueOrDefault())
                {
                    ...
                    {
                        throw new ErrorException(TerminalErrors.InvalidConfiguration, "The name is required if terminal root is a driver.");
                    }
                }
            }
            ...
            // Logging
            {
                ...
                {
                    throw new ErrorException(TerminalErrors.InvalidConfiguration, "The terminal logger indent cannot be less than or equal to zero. logger_indent={0}", options.Logging.LoggerIndent);
                }
            }
            ...
            // Separator
            {
                ...
                {
                    throw new ErrorException(TerminalErrors.InvalidConfiguration, "The command separator cannot be null or empty.", options.Extractor.Separator);
                }
                ...
                {
                    throw new ErrorException(TerminalErrors.InvalidConfiguration, "The command separator and option prefix cannot be same. separator={0}", options.Extractor.Separator);
                }
                ...
                {
                    throw new ErrorException(TerminalErrors.InvalidConfiguration, "The command separator and option alias prefix cannot be same. separator={0}", options.Extractor.Separator);
                }
            }
            ...
            // Option
            {
                ...
                {
                    throw new ErrorException(TerminalErrors.InvalidConfiguration, "The option separator cannot be null or empty.", options.Extractor.Separator);
                }

                // Option prefix cannot be null, empty or whitespace
                if (string.IsNullOrWhiteSpace(options.Extractor.OptionPrefix))
                {
                    throw new ErrorException(TerminalErrors.InvalidConfiguration, "The option prefix cannot be null or whitespace.");
                }

                // Option prefix cannot be more than 3 Unicode characters
                if (textHandler.TextLength(options.Extractor.OptionPrefix) > 3)
                {
                    throw new ErrorException(TerminalErrors.InvalidConfiguration, "The option prefix cannot be more than 3 Unicode characters. option_prefix={0}", options.Extractor.OptionPrefix);
                }

                // Option alias prefix cannot be null, empty or whitespace
                if (string.IsNullOrWhiteSpace(options.Extractor.OptionAliasPrefix))
                {
                    throw new ErrorException(TerminalErrors.InvalidConfiguration, "The option alias prefix cannot be null or whitespace.");
                }

                // Option prefix cannot be more than 3 Unicode characters
                if (textHandler.TextLength(options.Extractor.OptionAliasPrefix) > 3)
                {
                    throw new ErrorException(TerminalErrors.InvalidConfiguration, "The option alias prefix cannot be more than 3 Unicode characters. option_alias_prefix={0}", options.Extractor.OptionAliasPrefix);
                }
                ...
                {
                    throw new ErrorException(TerminalErrors.InvalidConfiguration, "The option separator and option prefix cannot be same. separator={0}", options.Extractor.OptionValueSeparator);
                }

                // Option separator and option prefix cannot be same
                if (textHandler.TextEquals(options.Extractor.OptionValueSeparator, options.Extractor.OptionAliasPrefix))
                {
                    throw new ErrorException(TerminalErrors.InvalidConfiguration, "The option separator and option alias prefix cannot be same. separator={0}", options.Extractor.OptionValueSeparator);
                }
                ...
                {
                    throw new ErrorException(TerminalErrors.InvalidConfiguration, "The option alias prefix cannot start with option prefix. prefix={0}", options.Extractor.OptionPrefix);
                }
            }
