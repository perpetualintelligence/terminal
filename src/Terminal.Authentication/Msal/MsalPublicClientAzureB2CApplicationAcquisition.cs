...
{
    /// <summary>
    /// The <see cref="IMsalApplicationAcquisition"/> to create <see cref="IPublicClientApplication"/> for Azure B2C.
    /// </summary>
    public class MsalPublicClientAzureB2CApplicationAcquisition : IMsalApplicationAcquisition<NoAcquisitionContext, IPublicClientApplication>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MsalPublicClientAzureB2CApplicationAcquisition"/> class.
        /// </summary>
        /// <param name="msalTokenCache">The MSAL token cache.</param>
        /// <param name="terminalOptions">The terminal options.</param>
        /// <param name="logger">The logger.</param>
        public MsalPublicClientAzureB2CApplicationAcquisition(
            IMsalTokenCache msalTokenCache,
            TerminalOptions terminalOptions,
            ILogger<MsalPublicClientAzureB2CApplicationAcquisition> logger)
        {
        ...
        /// <summary>
        /// Acquires an instance of <see cref="IPublicClientApplication"/> for Azure B2C authentication.
        /// </summary>
        ...
        public async Task<IPublicClientApplication> AcquireClientApplicationAsync(NoAcquisitionContext context)
        {
            IPublicClientApplication clientApp = PublicClientApplicationBuilder.Create(terminalOptions.Authentication.ApplicationId)
                                                   .WithB2CAuthority(terminalOptions.Authentication.Authority)
        ...
        private readonly ILogger<MsalPublicClientAzureB2CApplicationAcquisition> logger;
    }
}
