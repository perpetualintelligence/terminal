...
{
    /// <summary>
    /// Represents the output generated by the terminal server in response to <see cref="TerminalInputOutput"/>.
    /// </summary>
    public sealed class TerminalOutput
    {
        ...
        [JsonConstructor]
        public TerminalOutput(TerminalInputOutput input, string? senderId, string? senderEndpoint)
        {
        ...
        public TerminalInputOutput Input { get; }
