...
namespace OneImlx.Terminal.Runtime
{
    ...
    /// </summary>
    /// <remarks>
    /// The <see cref="TerminalStartContext"/> represents the context for starting a terminal session, including start
    /// mode, cancellation tokens, custom properties, and driver or command line arguments. It encapsulates all
    /// necessary information to initiate and control a terminal session, providing flexibility through custom
    /// properties and robust control via cancellation tokens.
    /// </remarks>
    public sealed class TerminalStartContext
    {
        ...
        /// <param name="arguments">The arguments or command line start arguments.</param>
        public TerminalStartContext(TerminalStartMode terminalStartMode, CancellationToken terminalCancellationToken, CancellationToken commandCancellationToken, Dictionary<string, object>? customProperties = null, string[]? arguments = null)
        {
