...
namespace OneImlx.Terminal.Events
{
    ...
    public interface ITerminalEventHandler
    {
        ...
        /// <remarks>
        /// The framework will call <see cref="AfterCommandRouteAsync(TerminalProcessorRequest, Command?, CommandRouterResult?)"/> even if there is an error during command routing.
